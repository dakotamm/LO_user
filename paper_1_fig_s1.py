...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  6 15:44:19 2025
...
for site in ['point_jefferson']:
    ...
    fig, ax = plt.subplot_mosaic(mosaic, figsize=(9,4), layout='constrained')
   ...
   # sns.scatterplot(data=plot_df[plot_df['site'] == site], x='year', y='z', ax=ax['depth_time_series'],  color='#ff4040', legend=False)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/paper_1_fig_s1.png', bbox_inches='tight', dpi=500, transparent=True)
    
# %%

odir = Ldir['LOo'] / 'obs' / 'collias' / 'bottle'

test = pd.read_pickle( odir / (str(1932) + '.p'))
