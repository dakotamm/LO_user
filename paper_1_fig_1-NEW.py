...
palette = {'point_jefferson':'#e04256', 'lynch_cove_mid':'#4565e8', 'near_seattle_offshore':'#e04256', 'saratoga_passage_mid':'#4565e8', 'carr_inlet_mid':'#4565e8'}
...
for var in var_list:
    ...
    for site in long_site_list:
        ...
        if var == 'DO_mg_L':
            ...
            sns.scatterplot(data=plot_df_q50, x='datetime', y = 'val',  ax=ax, color = palette[site], style='site')
            
        elif var == 'CT':
            
            plot_df = odf_use[(odf_use['site'] == site) & (odf_use['var'] == var) & (odf_use['surf_deep'] == 'deep') & (odf_use['season'] == 'loDO')]
            
            sns.scatterplot(data=plot_df, x='datetime', y = 'val',  ax=ax, color = palette[site], style='site')
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/paper_1_fig_1-NEW.png', bbox_inches='tight', dpi=500, transparent=True)
