...
Specific to DM fucntions - created 11/9/2023.
...
def intro():
    ...
    # optional arguments
    parser.add_argument('-f', '--frc', type=str, default='')        # e.g. tide
    parser.add_argument('-r', '--run_type', type=str, default='')   # backfill or forecast
    parser.add_argument('-s', '--start_type', type=str, default='') # new, continuation, or perfect
    parser.add_argument('-d', '--date_string', type=str, default='') # e.g. 2019.07.04
    parser.add_argument('-test', '--testing', default=False, type=Lfun.boolean_string)
    parser.add_argument('-ys', '--year_start', type=int, default=None)
    parser.add_argument('-ye', '--year_end', type=int, default=None)
    
    # optional arguments used only for ocnN, to determine what to nest inside
    parser.add_argument('-gtx', '--gtagex', default='cas7_t0_x4b', type=str) # e.g. cas6_traps2_x2b
    ...
    for a in ['frc', 'run_type', 'start_type', 'date_string', 'testing','gtagex','roms_out_num','do_bio','year_start', 'year_end']:
        Ldir[a] = argsd[a]
