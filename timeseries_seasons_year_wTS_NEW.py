...
sns.scatterplot(data = avg_df_filt[avg_df_filt['segment'] == seg], y = 'T_avg_below_deg_C', x = 'S_avg_below_g_kg', size = 'DO_avg_below_mg_L',alpha=0.7, sizes=(50,500), hue = 'season', palette='Paired', hue_order=['fall','winter','spring','summer'])

    
ax.set(ylabel = 'Temp. Avg. Bottom 20$\%$ [deg C]', xlabel = 'Sal. Avg. Bottom 20$\%$ [g/kg]')

ax.grid(alpha = 0.3)

fig.tight_layout()

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + seg.replace(" ", "") + '_avgbot20pct_SvT_DO_new.png', transparent = False, dpi=500)
...
for seg in avg_df['segment'].unique():
    ...
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'winter') & (avg_df_seasonal['segment'] == seg)], x = 'T_avg_below_deg_C', y = 'S_avg_below_g_kg', marker = 'o', ax = ax[0,0], hue = 'DO_avg_below_mg_L', legend = False)
        
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'spring') & (avg_df_seasonal['segment'] == seg)], x = 'T_avg_below_deg_C', y = 'S_avg_below_g_kg', marker = 'o', ax = ax[0,1], hue = 'DO_avg_below_mg_L', legend = False)

    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'summer') & (avg_df_seasonal['segment'] == seg)], x = 'T_avg_below_deg_C', y = 'S_avg_below_g_kg', marker = 'o', ax = ax[0,2], hue = 'DO_avg_below_mg_L', legend = False)
    
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'fall') & (avg_df_seasonal['segment'] == seg)], x = 'T_avg_below_deg_C', y = 'S_avg_below_g_kg', marker = 'o', ax = ax[0,3], hue = 'DO_avg_below_mg_L', sizes=(50,500), legend = False)
    ...
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'winter') & (avg_df_seasonal['segment'] == seg)], x = 'S_avg_below_g_kg', y = 'DO_avg_below_mg_L',  marker = 's', ax = ax[1,0],  hue = 'T_avg_below_deg_C', legend = False)
        
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'spring') & (avg_df_seasonal['segment'] == seg)], x = 'S_avg_below_g_kg', y = 'DO_avg_below_mg_L',  marker = 's', ax = ax[1,1], hue = 'T_avg_below_deg_C', legend = False)

    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'summer') & (avg_df_seasonal['segment'] == seg)], x = 'S_avg_below_g_kg', y = 'DO_avg_below_mg_L', marker = 's', ax = ax[1,2], hue = 'T_avg_below_deg_C', legend = False)
    
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'fall') & (avg_df_seasonal['segment'] == seg)], x = 'S_avg_below_g_kg', y = 'DO_avg_below_mg_L', marker = 's', ax = ax[1,3], hue = 'T_avg_below_deg_C', legend = False)
    ...
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'winter') & (avg_df_seasonal['segment'] == seg)], x = 'T_avg_below_deg_C', y = 'DO_avg_below_mg_L', color = clr,  marker = 'D', ax = ax[2,0], hue = 'S_avg_below_g_kg',  legend = False)
        
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'spring') & (avg_df_seasonal['segment'] == seg)], x = 'T_avg_below_deg_C', y = 'DO_avg_below_mg_L', color = clr, marker = 'D', ax = ax[2,1], hue = 'S_avg_below_g_kg', legend = False)

    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'summer') & (avg_df_seasonal['segment'] == seg)], x = 'T_avg_below_deg_C', y = 'DO_avg_below_mg_L', color = clr,  marker = 'D', ax = ax[2,2], hue = 'S_avg_below_g_kg', legend = False)
    
    sns.scatterplot(data = avg_df_seasonal[(avg_df_seasonal['season'] == 'fall') & (avg_df_seasonal['segment'] == seg)], x = 'T_avg_below_deg_C', y = 'DO_avg_below_mg_L', color = clr, marker = 'D', ax = ax[2,3], hue = 'S_avg_below_g_kg', legend = False)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + seg.replace(" ", "") + '_avgbot20pct_seasonal_TSDO_new.png', transparent = False, dpi=500)
...
sns.relplot(data = avg_df_seasonal[avg_df_seasonal['segment'] == seg], x = 'S_avg_below_g_kg', y = 'T_avg_below_deg_C', col = 'season', marker = 'o', hue = 'DO_avg_below_mg_L', palette = 'Spectral',  col_order=['winter','spring','summer','fall'], s=300)

#ax.grid(alpha=0.3)

fig.tight_layout()

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + seg.replace(" ", "") + '_avgbot20pct_seasonal_SvT_DO_new.png', transparent = False, dpi=500)
...
sns.relplot(data = avg_df_seasonal[avg_df_seasonal['segment'] == seg], x = 'T_avg_below_deg_C', y = 'DO_avg_below_mg_L', col = 'season',marker = 's', hue = 'S_avg_below_g_kg', palette = 'viridis', col_order=['winter','spring','summer','fall'], s=300)

#ax.grid(alpha=0.3)

fig.tight_layout()

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + seg.replace(" ", "") + '_avgbot20pct_seasonal_TvDO_S_new.png', transparent = False, dpi=500)
...
sns.relplot(data = avg_df_seasonal[avg_df_seasonal['segment'] == seg], x = 'S_avg_below_g_kg', y = 'DO_avg_below_mg_L', col = 'season', marker = 'D', hue = 'T_avg_below_deg_C', palette = 'coolwarm', col_order=['winter','spring','summer','fall'], s=300)

#ax.grid(alpha=0.3)

fig.tight_layout()

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + seg.replace(" ", "") + '_avgbot20pct_seasonal_SvDO_T_new.png', transparent = False, dpi=500)