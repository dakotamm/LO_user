...
# -*- coding: utf-8 -*-
"""
Created on Wed May 22 14:32:07 2024
...
fig, ax = plt.subplot_mosaic([['map']], figsize=(6,6), layout='constrained')

sns.scatterplot(data=plot_df_map, x='lon', y='lat', hue='name', ax = ax['map'], s = 100, palette='magma', legend=False, hue_order=['SARATOGARP', 'PENNCOVEENT', 'PENNCOVECW', 'PENNCOVEWEST'])
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/kc_pc_ctd_stations.png', dpi=500, transparent=False)


# %%

mosaic = [['DO_min'], ['Chl_max'],['NO3_max'],['SA_min'], ['CT_max']]

#plot_df_map = odf_pc.groupby('name').first().reset_index()

    
plot_df = odf_pc[(odf_pc['val'] >=0) & (odf_pc['name'].isin(['SARATOGARP','PENNCOVEWEST']))]

fig, ax = plt.subplot_mosaic(mosaic, layout='constrained', figsize=(8,12))
...
sns.lineplot(data=plot_df_DO, x='datetime', y = 'val', ax=ax['DO_min'], marker='o', hue='name', palette='magma', legend=False, hue_order=['SARATOGARP', 'PENNCOVEENT', 'PENNCOVECW', 'PENNCOVEWEST'])
...
sns.lineplot(data=plot_df_Chl, x='datetime', y = 'val', ax=ax['Chl_max'], marker='o', hue='name', palette='magma', legend=False, hue_order=['SARATOGARP', 'PENNCOVEENT', 'PENNCOVECW', 'PENNCOVEWEST'])
...
sns.lineplot(data=plot_df_NO3, x='datetime', y = 'val', ax=ax['NO3_max'], marker='o', hue='name', palette='magma', legend=False, hue_order=['SARATOGARP', 'PENNCOVEENT', 'PENNCOVECW', 'PENNCOVEWEST'])
...
sns.lineplot(data=plot_df_SA, x='datetime', y = 'val', ax=ax['SA_min'], marker='o', hue='name', palette='magma', legend=False, hue_order=['SARATOGARP', 'PENNCOVEENT', 'PENNCOVECW', 'PENNCOVEWEST'])
...
sns.lineplot(data=plot_df_CT, x='datetime', y = 'val', ax=ax['CT_max'], marker='o', hue='name', palette='magma', legend=False, hue_order=['SARATOGARP', 'PENNCOVEENT', 'PENNCOVECW', 'PENNCOVEWEST'])
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/kc_pc_vars.png', dpi=200, transparent=False)