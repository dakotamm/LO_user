...
G, S, T, land_mask, Lon, Lat, plon, plat, z_rho_grid, dz, dv, h = vfun.getGridInfo(fn_his)
...
info_df, df = vfun.getCleanDataFrames(info_fn, fn, h, land_mask, Lon, Lat, seg_list, jjj_dict, iii_dict)
