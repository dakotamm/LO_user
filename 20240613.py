...
mosaic = [['map_source', 'count_time_series', 'count_time_series', 'count_time_series'], ['map_source', 'depth_time_series', 'depth_time_series', 'depth_time_series']] #, ['map_source', '.', '.'],]
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/source_locations_freq_depth_PRESENT.png', bbox_inches='tight', dpi=500, transparent=True)
