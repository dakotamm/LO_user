...
for site in ['ps']:
    ...
    sns.scatterplot(data=plot_df, x='year', y = 'val',  ax=ax, hue='Surface5m_Bottom20pct', palette=colors, alpha=0.7)
    ...
    for var in ['surf_DO_mg_L','deep_DO_mg_L']:
        ...
        filt_df = all_stats_filt[(all_stats_filt['site'] == site) & (all_stats_filt['var'] == var)]
        ...
        if 'surf' in var:
            ...
            x = plot_df[plot_df['surf_deep'] == 'deep']['date_ordinal']
            
            x_plot = plot_df[plot_df['surf_deep'] == 'deep']['year']
            
            y = plot_df[plot_df['surf_deep'] == 'deep']['val']
