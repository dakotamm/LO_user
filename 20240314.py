...
mosaic = [['map', 'skagit_annual', 'skagit_annual', 'skagit_annual', 'skagit_annual','skagit_annual', 'skagit_annual', 'skagit_annual', 'skagit_annual'],
          
          ['map', 'hat_island_1940', 'hat_island_1950', 'hat_island_1960', 'hat_island_1970', 'hat_island_1980', 'hat_island_1990', 'hat_island_2000', 'hat_island_2010'],
          
          ['map', 'near_alki_1940', 'near_alki_1950', 'near_alki_1960', 'near_alki_1970', 'near_alki_1980', 'near_alki_1990', 'near_alki_2000', 'near_alki_2010']]
          
          # 'near_alki_1940'], ['map', 'hat_island_1950', 'near_alki_1950'],
        
          # ['map', 'hat_island_1960', 'near_alki_1960'], ['map', 'hat_island_1970', 'near_alki_1970'], ['map', 'hat_island_1980', 'c'],
          # ['map', 'hat_island_1990', 'near_alki_1990'], ['map', 'hat_island_2000', 'near_alki_2000'], ['map', 'hat_island_2010', 'near_alki_2010'],
          # ['map', 'hat_island_2020', 'near_alki_2020']]

fig, axd = plt.subplot_mosaic(mosaic, layout="constrained", figsize = (30,8 )) 
...
sns.lineplot(data=annual_skagit_df, x='year_nu', y='mean_va', ax = axd['skagit_annual'], color='darkgray')


sns.lineplot(data=annual_skagit_df, x='year_nu', y='mean_va_mean', ax = axd['skagit_annual'], color='black')
...
axd['skagit_annual'].set_xlim(1940, 2019)
...
for basin in ['hat_island', 'near_alki']:
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/prelim_skagit_decadal_hat_alki_all.png', dpi=500, transparent=False)
...
fig, axd = plt.subplot_mosaic(mosaic, layout="constrained", figsize = (15,10)) 
        ...
        for var in ['SA', 'CT', 'DO_mg_L']:
            ...
            if not plot_df.empty:
                ...
                axd[ax_name].fill_betweenx(plot_df[plot_df['decade'] == decade0]['z_mean'], plot_df[plot_df['decade'] == decade0]['val_ci95lo'], plot_df[plot_df['decade'] == decade0]['val_ci95hi'],
                                 zorder=-4, alpha=0.5, color=color0, label = decade0)
                ...
                axd[ax_name].fill_betweenx(plot_df[plot_df['decade'] == decade1]['z_mean'], plot_df[plot_df['decade'] == decade1]['val_ci95lo'], plot_df[plot_df['decade'] == decade1]['val_ci95hi'],
                                 zorder=-4, alpha=0.5, color=color1, label=decade1)
