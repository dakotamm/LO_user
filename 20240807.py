...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 14:20:52 2024
...
all_stats = all_stats.sort_values(by=['site'])

all_stats_filt = all_stats_filt.sort_values(by=['site'])


for site in all_stats['site'].unique():
    
    all_stats.loc[all_stats['site'] == site, 'site_num'] = c
...
#             #     ax.plot([plot_df.loc[idx,'site_num'], plot_df.loc[idx,'site_num']],[plot_df.loc[idx,'slope_datetime_cent_95lo'], plot_df.loc[idx,'slope_datetime_cent_95hi']], color='lightgray', alpha =0.2, linewidth =0.5)
                

#             sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent_95hi', palette='husl', hue = 'summer_def', hue_order=['~85% hypoxic days','Aug-Sep','Aug-MidOct','Aug-Oct','Aug-MidNov','Aug-Nov'], alpha =0.7, ax = ax, s= 10, legend=False)

#             sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent_95lo', palette='husl', hue = 'summer_def', hue_order=['~85% hypoxic days','Aug-Sep','Aug-MidOct','Aug-Oct','Aug-MidNov','Aug-Nov'],  alpha =0.7, ax = ax, s= 10, legend=False)

#             sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent', palette='husl', hue = 'summer_def', hue_order=['~85% hypoxic days','Aug-Sep','Aug-MidOct','Aug-Oct','Aug-MidNov','Aug-Nov'], alpha =0.7, ax = ax)

            
            
            
#             plot_df = all_stats_filt[(all_stats_filt['stat'] == stat) & (all_stats_filt['var'] == var) & (all_stats_filt['site'].isin(long_site_list))]
...
#             sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent_95hi', color = 'k', alpha =0.7, ax = ax, s= 10, legend=False)

#             sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent_95lo', color = 'k',  alpha =0.7, ax = ax, s= 10, legend=False)

#             sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent', color = 'k', alpha =0.7, ax = ax, label='bot50pctdeepDOAugNov')
...
#             #ax.set_xticks([20,21,22,23,24],site_labels, rotation=90) #, ha='right')
            
#             ax.set_xticks([0,1,2,3,4],site_labels, rotation=90) #, ha='right')
...
#     plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + var + '_' + stat + '_' + time_avg + '_allsummers_slopes_incl_bot50pctdeepDOAugNov.png', bbox_inches='tight', dpi=500, transparent=False)
...
for var in all_stats['var'].unique():
    ...
    for stat in ['mk_ts']:
        ...
        for time_avg in ['none']: 
            ...
            sns.scatterplot(data = plot_df[plot_df['summer_def'] == 'Aug-Nov'], x= 'site_num', y = 'slope_datetime_cent_95hi', color='k', alpha =0.7, ax = ax, s= 10, legend=False)

            sns.scatterplot(data = plot_df[plot_df['summer_def'] == 'Aug-Nov'], x= 'site_num', y = 'slope_datetime_cent_95lo', color='k',  alpha =0.7, ax = ax, s= 10, legend=False)

            sns.scatterplot(data = plot_df[plot_df['summer_def'] == 'Aug-Nov'], x= 'site_num', y = 'slope_datetime_cent', color='k', alpha =0.7, ax = ax, label='Aug-Nov')
            ...
            sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent_95hi', hue = 'deep_DO_q', alpha =0.7, ax = ax, s= 10, legend=False)

            sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent_95lo', hue = 'deep_DO_q',  alpha =0.7, ax = ax, s= 10, legend=False)

            sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent', hue = 'deep_DO_q', alpha =0.7, ax = ax)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + var + '_' + stat + '_' + time_avg + '_Aug-Nov_slopes_incl_wdeepDOpctAugNov.png', bbox_inches='tight', dpi=500, transparent=False)
