...
for basin in basin_list:
    ...
    plot_df = full_avgs_dict[basin][~np.isnan(full_avgs_dict[basin]['DO_mg_L'])]
            
    plt.scatter(plot_df['datetime'], plot_df['z'], color='k', sizes=[5])
    
    plt.title(basin + ' avg sampling depth')
