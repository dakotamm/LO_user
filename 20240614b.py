...
odf_dict, path_dict = dfun.getPolyData(Ldir, poly_list, source_list=['ecology_nc'], otype_list=['bottle', 'ctd'], year_list=np.arange(1930,2025))
...
odf_grow = odf[(odf['yearday'] > 125) & (odf['yearday'] <= 325)]
...
plot_df = odf[(odf['segment'] == 'ps') & (odf['var'] == 'DO_mg_L') & (odf['z'] >=-105) & (odf['z'] < -35) & (odf['year'] >= 2010) & (odf['year'] <= 2018)].groupby(['year_month']).mean(numeric_only=True).reset_index().dropna()
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/ecology_35-105m_2010-2018_PRESENT.png', bbox_inches='tight', dpi=500, transparent=True)

# %%

# all years 35-105m

plot_df = odf[(odf['segment'] == 'ps') & (odf['var'] == 'DO_mg_L') & (odf['z'] >=-105) & (odf['z'] < -35) ].groupby(['year_month']).mean(numeric_only=True).reset_index().dropna()
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/ecology_35-105m_all_years_PRESENT.png', bbox_inches='tight', dpi=500, transparent=True)
