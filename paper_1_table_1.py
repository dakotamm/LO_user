...
all_stats_disp = all_stats_filt[(all_stats_filt['var'].isin(['deep_DO_mg_L','deep_CT','deep_SA'])) & (all_stats_filt['season'] == 'loDO')]
...
all_stats_disp_use = all_stats_disp[['site', 'site_num', 'season','var','slope_datetime_cent', '95CI_hi_cent', '95CI_lo_cent']]
