...
def D_sect_pcb(in_dict): #DM added 2025/12/01
    """
    This plots a map and a section (distance, z), and makes sure
    that the color limits are identical.  If the color limits are
    set automatically then the section is the preferred field for
...
def D_sect_pca(in_dict): #DM added 2025/12/01
    """
    This plots a map and a section (distance, z), and makes sure
    that the color limits are identical.  If the color limits are
    set automatically then the section is the preferred field for
...
def D_sect_pc2(in_dict): #DM added 2025/12/01
    """
    This plots a map and a section (distance, z), and makes sure
    that the color limits are identical.  If the color limits are
    set automatically then the section is the preferred field for
...
def D_sect_pc1(in_dict): #DM added 2025/12/01
    """
    This plots a map and a section (distance, z), and makes sure
    that the color limits are identical.  If the color limits are
    set automatically then the section is the preferred field for
...
def D_sect_pc0(in_dict): #DM added 2025/11/26
    """
    This plots a map and a section (distance, z), and makes sure
    that the color limits are identical.  If the color limits are
    set automatically then the section is the preferred field for
...
def D_bottom_DO(in_dict): # DM created 2025/11/12 # zoom into just PC and add quiver 20260210
    ...
    for vn in vn_list:
        ...
        pfun.add_velocity_vectors(ax, ds, in_dict['fn'], v_scl=5, v_leglen=0.1, nngrid=20)
