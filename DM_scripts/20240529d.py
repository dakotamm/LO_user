...
# -*- coding: utf-8 -*-
"""
Created on Wed May 29 15:33:24 2024
...
short_exclude_sites = ['QMH002', 'PMA001', 'OCH014', 'DYE004', 'SUZ001', 'HLM001', 'PNN001', 'PSS010', 'TOT002', 'TOT001', 'HND001','ELD001', 'ELD002', 'CSE002', 'CSE001', 'HCB010', 'SKG003','HCB006', 'HCB008', 'HCB009']
...
ax.pcolormesh(plon, plat, zm_inverse, linewidth=0.5, vmin=-1000, vmax=0, cmap = 'gray') #cmap=plt.get_cmap(cmocean.cm.ice))
...
for site in long_site_list:
    ...
    if site == 'point_jefferson':
        ...
        patch = patches.PathPatch(path, facecolor='blue', alpha=0.5, edgecolor='blue', label='>60-year history')
        
    else: 
        
        patch = patches.PathPatch(path, facecolor='blue', alpha=0.5, edgecolor='blue')
...
for site in short_site_list:
    ...
    if site == 'KSBP01':
        ...
        sns.scatterplot(data=lat_lon_df[lat_lon_df['site']==site], x='lon', y='lat', facecolor='cyan', alpha=0.5, edgecolor='cyan', ax = ax, s=50, label='~20-year history')
    
    else:
        
        sns.scatterplot(data=lat_lon_df[lat_lon_df['site']==site], x='lon', y='lat', facecolor='cyan', alpha=0.5, edgecolor='cyan', ax = ax, s=50)
...
# plot with all T/SA/density trends...

# %%

# using jefferson site, oscillation study...?

# autocorrelation with lags

# 1:1 correlations? between T and DO...
