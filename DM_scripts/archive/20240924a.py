...
for var in ['deep_DO_mg_L', 'deep_CT', 'deep_SA']:
    ...
    for stat in ['mk_ts']:
        ...
        for deep_DO_q in ['deep_DO_q50']:
            ...
            plot_df = all_stats_filt[(all_stats_filt['stat'] == stat) & (all_stats_filt['var'] == var) & (all_stats_filt['site'].isin(long_site_list)) & (all_stats_filt['deep_DO_q'] == deep_DO_q) & (all_stats_filt['summer_non_summer'] == 'summer')]
            ...
            if var == 'deep_DO_mg_L':
                ...
                plot_df_sat = all_stats_filt[(all_stats_filt['stat'] == stat) & (all_stats_filt['var'] == 'deep_DO_sol') & (all_stats_filt['site'].isin(long_site_list)) & (all_stats_filt['deep_DO_q'] == deep_DO_q) & (all_stats_filt['summer_non_summer'] == 'summer')]
                
                plot_df_sat = plot_df_sat.sort_values(by=['site']).reset_index()
                
                plot_df_sat['slope_datetime_cent'] = plot_df_sat['slope_datetime']*100
                
                plot_df_sat['slope_datetime_cent_95hi'] = plot_df_sat['slope_datetime_s_hi']*100
                
                plot_df_sat['slope_datetime_cent_95lo'] = plot_df_sat['slope_datetime_s_lo']*100
                
                
                # sns.scatterplot(data = plot_df_sat[plot_df_sat['site_type'] == 'Main Basin'], x= 'site_num', y = 'slope_datetime_cent_95hi', hue ='site_type', palette = palette, marker="$\circ$", ax = ax, s= 40, alpha=0.7, legend=False)
        
                # sns.scatterplot(data = plot_df_sat[plot_df_sat['site_type'] == 'Main Basin'], x= 'site_num', y = 'slope_datetime_cent_95lo', hue ='site_type', palette = palette, marker="$\circ$", ax = ax, s= 40, alpha=0.7, legend=False)
        
                sns.scatterplot(data = plot_df_sat[plot_df_sat['site_type'] == 'Main Basin'], x= 'site_num', y = 'slope_datetime_cent', hue ='site_type', palette = palette, marker="$\circ$", ax = ax, s =200, alpha=0.7, legend=False)
                
                
                
                # sns.scatterplot(data = plot_df_sat[plot_df_sat['site_type'] == 'Sub-Basins'], x= 'site_num', y = 'slope_datetime_cent_95hi', hue ='site_type', palette = palette, marker="$\circ$", ax = ax, s= 40, alpha=0.7, legend=False)
        
                # sns.scatterplot(data = plot_df_sat[plot_df_sat['site_type'] == 'Sub-Basins'], x= 'site_num', y = 'slope_datetime_cent_95lo', hue ='site_type', palette = palette, marker="$\circ$", ax = ax, s= 40, alpha=0.7, legend=False)
        
                sns.scatterplot(data = plot_df_sat[plot_df_sat['site_type'] == 'Sub-Basins'], x= 'site_num', y = 'slope_datetime_cent', hue ='site_type', palette = palette, marker="$\circ$", ax = ax, s =200, alpha=0.7, legend=False)
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/longsites_deepDOvDOsat.png', dpi=500,transparent=True, bbox_inches='tight')   
