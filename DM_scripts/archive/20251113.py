...
for m in ms:
    ...
    moor_fn = moor_dir / g / 'moor' / 'pc2'/ fn
    ...
    fig.suptitle(m)
    plt.tight_layout()
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/'+ m + '_pc2_lowpass_CT_SA_DO_u_v.png',
...
#fig.suptitle(m)
plt.tight_layout()
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/M1_pc2_lowpass_u.png',
            dpi=500, transparent=True, bbox_inches='tight')
