...
mosaic = [['deep_DO_sol', 'deep_DO_sol_const_CT', 'deep_DO_sol_const_SA']]
...
for var in ['deep_DO_sol', 'deep_DO_sol_const_CT', 'deep_DO_sol_const_SA']:
    ...
    for stat in ['mk_ts']:
        ...
        for deep_DO_q in ['deep_DO_q50']:
            ...
            plot_df_ = all_stats_filt[(all_stats_filt['stat'] == stat) & (all_stats_filt['season'] == 'loDO') & (all_stats_filt['var'] == var) & (all_stats_filt['site'].isin(long_site_list)) & (all_stats_filt['deep_DO_q'] == deep_DO_q)]
            ...
            if var == 'deep_DO_sol':
                ...
                sns.scatterplot(data = plot_df_, x= 'site_num', y = 'slope_datetime_cent', color = '#dd9404', marker=marker_, ax = ax, s =150)
            ...
            label = var #label_depth + ' ' + label_var
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/loDO_bottom_DO_sol_const_SA_const_CT.png', dpi=500,transparent=False, bbox_inches='tight')
