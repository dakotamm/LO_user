...
mosaic = [['grow_surf_SA', 'grow_deep_SA'],
          ['loDO_surf_SA', 'loDO_deep_SA'],
          ['winter_surf_SA', 'winter_deep_SA']]

fig, axd = plt.subplot_mosaic(mosaic, figsize=(10,10), layout='constrained', sharex=True, sharey=True, gridspec_kw=dict(wspace=0.1, hspace=0.1))
...
for season in ['loDO', 'winter', 'grow']:
    ...
    for depth  in ['deep', 'surf']:
        ...
        for var in [depth+'_SA']: #,depth +'_CT',  depth+'_DO_mg_L''deep_DO_mg_L', 'deep_CT', 'deep_SA']:
            ...
            for stat in ['mk_ts']:
                ...
                for deep_DO_q in ['deep_DO_q50']:
                    ...
                    label = label_depth + ' ' + label_season #label_var
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/SA_trends_sharedaxes.png', dpi=500,transparent=True, bbox_inches='tight')
