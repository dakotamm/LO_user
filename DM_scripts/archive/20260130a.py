...
cs = ax.pcolormesh(plon_u, plat_u, mean_u_3d[0], cmap=cmo.balance, vmin=-0.1,vmax=0.1)
...
ax.set_title('Neap Flood u [m/s] ' + 'Bottom\n' +Ldir['ds0']+ ' ' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00')

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_bottom_u_neap_flood_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
ax.set_title('Neap Ebb u [m/s] ' + 'Bottom\n' +Ldir['ds0']+ ' ' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00')

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_bottom_u_neap_ebb_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
ax.set_title('Spring Flood u [m/s] ' + 'Bottom\n' +Ldir['ds0']+ ' ' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00')

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_bottom_u_spring_flood_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
ax.set_title('Spring Ebb u [m/s] ' + 'Bottom\n' +Ldir['ds0']+ ' ' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00')

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_bottom_u_spring_ebb_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
