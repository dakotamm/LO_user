...
odf_use_SA_old = odf_depth_mean[odf_depth_mean['var'] == 'SA']

odf_use_SA_old = pd.merge(odf_use_SA_old, annual_seasonal_skagit_means[['year', 'grow', 'loDO', 'winter']], how='left', on = ['year'])
    ...
    for season_SA in ['grow', 'loDO', 'winter']:
        ...
        for depth in ['surf', 'deep']:
            ...
            for season_skagit in ['grow', 'loDO', 'winter']:
                ...
                plot_df = odf_use_SA_old[(odf_use_SA_old['site'] == site) & (odf_use_SA_old['season'] == season_SA) & (odf_use_SA_old['surf_deep'] == depth)]
...
# %% ^redoing from yesterday after realizing weird season overlap issue - stuff for today >>>

# %%

odf_use, odf_calc_use = dfun.seasonalDepthAverageDF(odf_depth_mean, odf_calc_long)
...
for site in site_list:
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' +site + '_lastseasonSkagit_vs_SA.png', dpi=500)
...
for site in site_list:
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' +site + '_sameseasonSkagit_vs_SA.png', dpi=500)
...
for site in site_list:
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' +site + '_twoseasonsagoSkagit_vs_SA.png', dpi=500)
