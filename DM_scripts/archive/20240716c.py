...
for site in odf_use_DO_min_deep['site'].unique():
    ...
    ax[1].axhspan(213,289, color = 'lightgray', alpha = 0.2)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_min_DO_study_deep_augmidoct.png', bbox_inches='tight', dpi=500, transparent=False)
