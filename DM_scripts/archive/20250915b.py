...
for site in long_site_list:
    ...
    if site in ['point_jefferson', 'near_seattle_offshore']:
        ...
        patch = patches.PathPatch(path, facecolor='gray', edgecolor='white', zorder=1)#, label='>60-year history') facecolor='#ff4040'
        
    else:
        
        patch = patches.PathPatch(path, facecolor='gray', edgecolor='white', zorder=1) #facecolor='#4565e8'
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/long_sites_EPOC_PRESENT.png', bbox_inches='tight', dpi=500,transparent=True)
