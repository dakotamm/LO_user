...
for site in ['point_jefferson']:
    ...
    plot_df = odf_use_DO_min[odf_use_DO_min['site'] == site]
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_min_DO_study.png', bbox_inches='tight', dpi=500, transparent=False)
...
for site in ['point_jefferson']:
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_min_DO_study_deep.png', bbox_inches='tight', dpi=500, transparent=False)
