...
for site in ['ps']:
    ...
    #for var in ['surf_DO_mg_L','deep_DO_mg_L']:
        ...
        ax.text(0.5,y_spot, "NOTE: Some observed variability is due to biases introduced by\ninconsistent sampling location, depth, and frequency\nthroughout the time series.", horizontalalignment='center', verticalalignment='bottom', transform=ax.transAxes, color=color, bbox=dict(facecolor='white', alpha=0.9, edgecolor='none'), wrap=False)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_surfdeepDO_timeseries_transparent_alldepths_bg.png', bbox_inches='tight', dpi=500, transparent=True)
