...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 30 14:26:56 2024
...
for stat in ['mk_ts']:
    ...
    for season in ['summer']:
        ...
        for deep_DO_q in ['deep_DO_q50']:
            ...
            # pink = '#E91E63', purple = '#673AB7', blue = '#0504aa'
            ...
            sns.scatterplot(data = plot_df[plot_df['var'] == 'DO_sol'], x= 'site_num', y = 'slope_datetime_cent_95hi', color = color, marker=marker, ax = ax, s= 10, legend=False)
    
            sns.scatterplot(data = plot_df[plot_df['var'] == 'DO_sol'], x= 'site_num', y = 'slope_datetime_cent_95lo', color = color, marker=marker, ax = ax, s= 10, legend=False)
    
            sns.scatterplot(data = plot_df[plot_df['var'] == 'DO_sol'], x= 'site_num', y = 'slope_datetime_cent', color = color, marker=marker, ax = ax, s =50, label='Surface Saturation')
            ...
            plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + 'longsites_' + stat + '_' + season + '_' + deep_DO_q + '_slopes_DOsoldeepDO.png', dpi=500,transparent=False, bbox_inches='tight')