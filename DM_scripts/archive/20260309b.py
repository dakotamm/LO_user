...
mosaic = [['M1-M3-M5_bottom_DO']]

fig, axd = plt.subplot_mosaic(mosaic, figsize=(7,3), layout='constrained', gridspec_kw=dict(wspace=0.1), sharex=True)
...
ax.text(0.025,0.9, '[DO] at bottom at three points', transform=ax.transAxes, fontweight='bold', color = 'k')
...
#plt.savefig('/Users/dakotamascarenas/Desktop/pltz/DO_timeseries_M1-M3-M5.png', bbox_inches='tight', dpi=500, transparent=True)
