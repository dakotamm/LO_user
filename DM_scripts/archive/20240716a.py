...
for site in odf_dens_use['site'].unique():
    ...
    for season in ['summer']:
        ...
        plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_' + season + '_strat_sol_augoct.png', bbox_inches='tight', dpi=500, transparent=False)
...
for site in odf_use['site'].unique():
    ...
    for var in ['DO_mg_L', 'CT', 'SA']:
        ...
        for season in ['summer']:
            ...
            sns.scatterplot(data=plot_df, x='datetime', y ='val_mean', hue = 'surf_deep', palette=colors, ax=ax[ax_name], alpha=0.7, legend = False, marker=marker)   
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_surf_deep_decadal_nostrat_augoct.png', bbox_inches='tight', dpi=500, transparent=False)
...
for site in odf_use_DO_min_deep['site'].unique():
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_min_DO_study_deep_augoct.png', bbox_inches='tight', dpi=500, transparent=False)