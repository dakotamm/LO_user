...
import figure_functions as ffun
...
ax = axd['map_big']
ax.pcolormesh(plon, plat, zm, linewidth=0.5, vmin=-20, vmax=0, cmap = cmo.ice, zorder=-5)
...
ffun.dar(ax)
ax = axd['map_ps']
ax.pcolormesh(plon, plat, zm, linewidth=0.5, vmin=-20, vmax=1, cmap = cmo.ice, zorder=-5)
ax.pcolormesh(plon, plat, zm_inverse, linewidth=0.5, vmin=-20, vmax=0, cmap = 'gray', zorder=-5)
