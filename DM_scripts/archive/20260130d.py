...
for fn in fn_list:
   ...
   # u_poly = np.where(mask3, u, np.nan)
    ...
    salt_poly_depth_avg = np.mean(salt_poly, axis=0)
    
    if sum_salt_depth_avg is None:
        sum_salt_depth_avg = salt_poly_depth_avg.copy()
    else:
        sum_salt_depth_avg += salt_poly_depth_avg
    
    count +=1
    
mean_salt_depth_avg_2d = sum_salt_depth_avg / count
...
ax.set_title('Neap Flood Salinity [g/kg] ' + 'Depth-Averaged\n' +Ldir['ds0']+ ' ' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00')

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_depth_avg_SA_neap_flood_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
ax.set_title('Neap Ebb Salinity [g/kg] ' + 'Depth-Averaged\n' +Ldir['ds0']+ ' ' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00')

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_depth_avg_SA_neap_ebb_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
ax.set_title('Spring Flood Salinity [g/kg] ' + 'Depth-Averaged\n' +Ldir['ds0']+ ' ' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00')

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_depth_avg_SA_spring_flood_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
ax.set_title('Spring Ebb Salinity [g/kg] ' + 'Depth-Averaged\n' +Ldir['ds0']+ ' ' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00')

plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_depth_avg_SA_spring_ebb_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
