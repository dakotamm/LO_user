...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 13 15:31:51 2024
    ...
    for stat in ['mk_ts']:
        ...
        for season in ['non_summer', 'summer']:
            ...
            for deep_DO_q in ['deep_DO_q25', 'deep_DO_q50', 'deep_DO_q75']:
                ...
                plot_df = all_stats_filt[(all_stats_filt['stat'] == stat) & (all_stats_filt['summer_non_summer'] == season) & (all_stats_filt['var'] == var) & (all_stats_filt['site'].isin(site_list)) & (all_stats_filt['deep_DO_q'] == deep_DO_q)]
                ...
                sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent', color = color, ax = ax, s =100)
                
                for idx in plot_df.index:
                    
                    ax.plot([plot_df.loc[idx,'site_num'], plot_df.loc[idx,'site_num']],[plot_df.loc[idx,'slope_datetime_cent_95lo'], plot_df.loc[idx,'slope_datetime_cent_95hi']], color=color, alpha =0.7, zorder = -4)
                ...
                plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + var + '_' + stat + '_' + season + '_' + deep_DO_q + '_slopes.png', dpi=500,transparent=False, bbox_inches='tight')
