...
# odf_dict = dfun.getPolyData(Ldir, poly_list, source_list=['collias', 'ecology', 'kc', 'kc_taylor', 'kc_whidbey', 'nceiSalish', 'kc_point_jefferson'], otype_list=['bottle', 'ctd'], year_list=np.arange(1970,2025))
...
#                      .assign(
#                          datetime=(lambda x: pd.to_datetime(x['time'], utc=True)), # !!!! NOT SURE IF THAT'S COOL, NEED TO CHECK IF ALL ELSE IS IN UTC!!!
...
# for decade in ['1970', '1980', '1990', '2000', '2010', '2020']: #'1930', '1940', '1950', '1960', '1970', '1980', 
...
#                     sns.scatterplot(data=plot_df_map, x='lon', y='lat', hue='source_type', hue_order = ['collias_bottle', 'ecology_bottle', 'ecology_ctd', 'kc_bottle', 'kc_whidbey_ctd', 'kc_taylor_bottle', 'nceiSalish_bottle', 'kc_ctd', 'kc_point_jefferson_bottle', 'kc_point_jefferson_ctd'], alpha = 0.5, ax = ax, legend = False)
                    
#                     sns.scatterplot(data=plot_df, x='val', y='z', hue='source_type', hue_order = ['collias_bottle', 'ecology_bottle', 'ecology_ctd', 'kc_bottle', 'kc_whidbey_ctd', 'kc_taylor_bottle', 'nceiSalish_bottle', 'kc_ctd', 'kc_point_jefferson_bottle', 'kc_point_jefferson_ctd'], alpha=0.5, linewidth=0, ax = axx)
...
poly_list = ['ps', 'mb', 'wb', 'ss', 'hc', 'carr_inlet_mid', 'hat_island', 'hood_canal_mouth', 'lynch_cove_mid', 'near_seattle_offshore', 'port_susan_mid', 'saratoga_passage_north', 'saratoga_passage_mid', 'point_jefferson', 'elliott_bay', 'near_alki', 'off_port_madison']

odf_dict = dfun.getPolyData(Ldir, poly_list, source_list=['collias', 'ecology', 'kc', 'kc_taylor', 'kc_whidbey', 'nceiSalish', 'kc_point_jefferson'], otype_list=['bottle', 'ctd'], year_list=np.arange(1930,2025))
...
odf_use = pd.concat([odf_grow_bottom, odf_grow_lynch_cove_mid, odf_grow_elliott_bay], ignore_index=True)
