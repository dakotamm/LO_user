...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  3 14:15:30 2025
...
site_dt_counts = (odf
                      .dropna()
                      .groupby(['site','datetime']).agg({'cid' :lambda x: x.nunique()})
                      .reset_index()
...
site_dt_counts_2plus = site_dt_counts[site_dt_counts['cid_count'] >1]

# %%

site_dt_counts_3plus = site_dt_counts[site_dt_counts['cid_count'] >2]

# %%

dts_3plus = site_dt_counts['datetime']
