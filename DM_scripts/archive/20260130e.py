...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_surface_SA_neap_flood_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_surface_SA_neap_ebb_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_surface_SA_spring_flood_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/pc_surface_SA_spring_ebb_' + Ldir['ds0']+ '_' + str(his_num_list[0]).zfill(2) + '00-' + str(his_num_list[-1]).zfill(2) + '00.png', dpi=500, transparent=False, bbox_inches='tight')
