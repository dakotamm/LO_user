...
df_temp = pd.merge(vol_df_filt, wtd_avg_df_filt[['segment','month','season','year','DO_wtd_avg_below_mg_L']], how='left', on=['segment','year','season','month'])

df = pd.merge(df_temp,avg_df_filt[['segment','month','year','season','DO_avg_below_mg_L']], how='left', on=['segment','year','season','month'])
...
if seg_str[0] == 'sound_straits':
    ...
    sns.pairplot(df, x_vars=['year','season','month', 'num_casts', 'vol_km3','DO_wtd_avg_below_mg_L','DO_avg_below_mg_L'], y_vars=['vol_km3','DO_wtd_avg_below_mg_L','DO_avg_below_mg_L'], hue ='segment', palette = 'Set2', hue_order = ['Strait of Georgia', 'Strait of Juan de Fuca', 'Puget Sound'], dropna=True, height = 5)
    
    fig.tight_layout()
    
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + str(years[0]) +'-'+ str(years[-1]) + '_sub_2mg_vol_'+ seg_str[0]+ '_vol_avg_pairplot.png', transparent=False, dpi=500)
    
elif seg_str[0] == 'basins':
    
    fig, ax = plt.subplots(1,1,figsize=(27,27))
    
    ax0 = sns.pairplot(df, x_vars=['year','season','month', 'num_casts', 'vol_km3','DO_wtd_avg_below_mg_L','DO_avg_below_mg_L'], y_vars=['vol_km3','DO_wtd_avg_below_mg_L','DO_avg_below_mg_L'], hue ='segment', palette = 'Set2_r', hue_order = ['Admiralty Inlet','Whidbey Basin','South Sound','Hood Canal','Main Basin'], dropna=True, height = 5)
    
    fig.tight_layout()
    
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + str(years[0]) +'-'+ str(years[-1]) + '_sub_2mg_vol_'+ seg_str[0]+ '_vol_avg_pairplot_PSonly.png', transparent=False, dpi=500)

    spots = ['Whidbey Basin', 'Hood Canal']

    fig, ax = plt.subplots(1,1,figsize=(27,27))
    
    ax0 = sns.pairplot(df, x_vars=['year','season','month', 'num_casts', 'vol_km3','DO_wtd_avg_below_mg_L','DO_avg_below_mg_L'], y_vars=['vol_km3','DO_wtd_avg_below_mg_L','DO_avg_below_mg_L'], hue ='segment', palette = 'Set2_r', hue_order =['Whidbey Basin', 'Hood Canal'], dropna=True, height = 5)
    
    fig.tight_layout()
    
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + str(years[0]) +'-'+ str(years[-1]) + '_sub_2mg_vol_'+ seg_str[0]+ '_vol_avg_pairplot_WBHConly.png', transparent=False, dpi=500)
...
if seg_str[0] == 'sound_straits':
    ...
    sns.pairplot(df, x_vars=['year','season','month', 'num_casts', 'vol_km3','DO_wtd_avg_below_mg_L','DO_avg_below_mg_L','segment'], y_vars=['vol_km3','DO_wtd_avg_below_mg_L','DO_avg_below_mg_L'], dropna=True, height = 5) #, hue ='segment', palette = 'Set2', hue_order = ['Strait of Georgia', 'Strait of Juan de Fuca', 'Puget Sound'], dropna=True, height = 5)
    
    fig.tight_layout()
    
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + str(years[0]) +'-'+ str(years[-1]) + '_sub_2mg_vol_'+ seg_str[0]+ '_vol_avg_pairplot_segsincl.png', transparent=False, dpi=500)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + str(years[0]) +'-'+ str(years[-1]) + '_sub_2mg_vol_'+ seg_str[0]+ '_vol_avg_pairplot_PS_only_segsincl.png', transparent=False, dpi=500)
