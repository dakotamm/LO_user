...
odf_DO_pred['T_s_cons_T'] = np.log((298.15 - odf_DO_pred['surf_CT_cons'])/(273.15 - odf_DO_pred['surf_CT_cons']))

odf_DO_pred['C_o_*_cons_T'] = np.exp(A_0 + A_1*odf_DO_pred['T_s_cons_T'] + A_2*odf_DO_pred['T_s_cons_T']**2 + A_3*odf_DO_pred['T_s_cons_T']**3 + A_4*odf_DO_pred['T_s_cons_T']**4 + A_5*odf_DO_pred['T_s_cons_T']**5 + 
                       odf_DO_pred['surf_SA']*(B_0 + B_1*odf_DO_pred['T_s_cons_T'] + B_2*odf_DO_pred['T_s_cons_T']**2 + B_3*odf_DO_pred['T_s_cons_T']**3) + C_0*odf_DO_pred['surf_SA']**2)

odf_DO_pred['DO_sol_cons_T'] =  (odf_DO_pred['surf_dens_cons_T']/1000 + 1)*32/1000

# %%

odf_DO_pred['C_o_*_cons_S'] = np.exp(A_0 + A_1*odf_DO_pred['T_s'] + A_2*odf_DO_pred['T_s']**2 + A_3*odf_DO_pred['T_s']**3 + A_4*odf_DO_pred['T_s']**4 + A_5*odf_DO_pred['T_s']**5 + 
                       odf_DO_pred['surf_SA_cons']*(B_0 + B_1*odf_DO_pred['T_s'] + B_2*odf_DO_pred['T_s']**2 + B_3*odf_DO_pred['T_s']**3) + C_0*odf_DO_pred['surf_SA_cons']**2)

odf_DO_pred['DO_sol_cons_S'] =  (odf_DO_pred['surf_dens_cons_S']/1000 + 1)*32/1000
...
#odf_DO_pred = odf_DO_pred[['site', 'year','summer_non_summer', 'date_ordinal', 'cid', 'DO_sol']]
...
annual_counts_sol= (odf_depth_mean
                      .dropna()
                      #.set_index('datetime')
                      .groupby(['site','year','summer_non_summer']).agg({'cid' :lambda x: x.nunique()})
                      .reset_index()
...
odf_DO_pred_use = odf_DO_pred.groupby(['site', 'summer_non_summer', 'year']).agg({'DO_sol':['mean', 'std'], 'date_ordinal':['mean']})
...
odf_DO_pred_use = pd.merge(odf_DO_pred_use, annual_counts_sol, how='left', on=['site','summer_non_summer','year'])
