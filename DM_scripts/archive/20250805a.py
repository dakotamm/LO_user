        ...
        for depth in ['deep']:
            ...
            for season in ['loDO']:
                ...
                if var == 'DO_mg_L':  
                    ...
                    # Define the GAM model
                    gam_DO_q50 = LinearGAM(s(0))
                    
                    # Fit the model to the data
                    gam_DO_q50.fit(plot_df_DO_q50['datetime'], plot_df_DO_q50['val'])
                    
                    x_pred_DO_q50 = plot_df_DO_q50['datetime']

                    y_pred_DO_q50 = gam_DO_q50.predict(x_pred_DO_q50)
                    ...
                    if site == 'point_jefferson':
                        ...
                        ax.plot(x_pred, y_pred, color='grey')
                        ...
                        ax.plot(x_pred_DO_q50, y_pred_DO_q50, color = 'k') #color=palette[plot_df['site_type'].iloc[0]])
                        ...
                        ax.plot(x_pred, y_pred, color='gray')
                    ...
                    if site in ['point_jefferson', 'carr_inlet_mid']:
                        ...
                        ax.plot(x_pred, y_pred, color = 'k') #color=palette[plot_df['site_type'].iloc[0]])
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/paper_1_fig_6-GAM_testa.png', bbox_inches='tight', dpi=500, transparent=True)            
