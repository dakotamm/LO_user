    ...
    for season in ['summer']:
        ...
        for var in odf_dens_use['var'].unique():
           ...
           # ax[ax_name].text(0.99,0.99, 'slope = ' + str(np.round(slope_datetime,3)) + ' /yr +/- ' + str(np.round(sB1,6)), horizontalalignment='right', verticalalignment='top', transform=ax[ax_name].transAxes)
            ...
            ax[ax_name].text(0.99,0.99, 'slope = ' + str(np.round(slope_datetime*100,3)) + ' /century +/- ' + str(np.round(slope_datetime_s*100,3)), horizontalalignment='right', verticalalignment='top', transform=ax[ax_name].transAxes)
            ...
            if  'cons_S' in var:
                ...
                ax[ax_name].text(0.01,0.99, 'cons salinity (avg)', horizontalalignment='left', verticalalignment='top', transform=ax[ax_name].transAxes)
                
            elif 'cons_T' in var:
                
                ax[ax_name].text(0.01,0.99, 'cons temperature (avg)', horizontalalignment='left', verticalalignment='top', transform=ax[ax_name].transAxes)
    ...
    for var in ['DO_mg_L', 'CT', 'SA']:
        ...
        for season in ['summer']:
            ...
            for depth in ['surf', 'deep']:
                ...
                ax[ax_name].text(0.99,y, 'slope = ' + str(np.round(slope_datetime*100,3)) + ' /century +/- ' + str(np.round(slope_datetime_s*100,3)), horizontalalignment='right', verticalalignment='top', transform=ax[ax_name].transAxes, color=color)
