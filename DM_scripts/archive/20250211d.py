...
all_stats_filt.loc[all_stats_filt['site'] == 'lynch_cove_mid']
    ...
    for stat in ['mk_ts']:
        ...
        for season in ['summer']:
            ...
            for deep_DO_q in ['deep_DO_q25', 'deep_DO_q50', 'deep_DO_q75']:
                ...
                plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + var + '_' + stat + '_' + season + '_' + deep_DO_q + '_longshortslopes_onlylongsites_ws.png', dpi=500,transparent=False, bbox_inches='tight')
