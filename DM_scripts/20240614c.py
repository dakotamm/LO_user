...
for site in ['point_jefferson']:
    ...
    fig, ax = plt.subplot_mosaic(mosaic, layout='constrained', figsize = (10,6), sharex=True)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_surf_deep_decadal_PRESENT.png', bbox_inches='tight', dpi=500, transparent=True)
