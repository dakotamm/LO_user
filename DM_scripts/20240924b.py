...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 12 15:10:08 2024
...
sns.scatterplot(data=plot_df, x='lon', y='lat', color = 'gray', ax = ax['map_source'], alpha=0.5, legend=False)
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/source_locations_PECS_PRESENT.png', bbox_inches='tight', dpi=500, transparent=True)
