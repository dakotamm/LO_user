...
fig, axd = plt.subplot_mosaic(mosaic, figsize=(8,4), layout='constrained', gridspec_kw=dict(wspace=0.1))
...
sns.scatterplot(data=plot_df, x='datetime', y='val', ax=ax, alpha=0.5, color = 'gray', label='Sea-Tac Air Temperature Annual Averages')
...
sns.scatterplot(data=plot_df_surf_CT, x='datetime', y='val', ax=ax, color = '#4565e8', label = 'PJ Surface Temperature Fall Averages')
...
sns.scatterplot(data=plot_df_deep_CT, x='datetime', y='val', ax=ax, color = '#e04256', label = 'PJ Deep Temperature Fall Averages')
...
ax.set_xticks([0,1,2,3],['Offshore', 'PJ Deep Fall', 'PJ Surface Fall', 'Sea-Tac (Air)'])
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/surfdeepPJ_seatac_offshore.png', dpi=500,transparent=True, bbox_inches='tight')   
