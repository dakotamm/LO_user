...
for var in all_stats['var'].unique():
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + var + '_' + stat + '_' + time_avg + '_allsummers_slopes.png', bbox_inches='tight', dpi=500, transparent=False)
...
for var in all_stats['var'].unique():
    ...
    for stat in ['mk_ts']:
        ...
        for time_avg in ['none']: 
            ...
            sns.scatterplot(data = plot_df[plot_df['summer_def'] == 'Aug-Nov'], x= 'site_num', y = 'slope_datetime_cent_95hi', palette='husl', hue = 'summer_def', hue_order=['~85% hypoxic days','Aug-Sep','Aug-MidOct','Aug-Oct','Aug-MidNov','Aug-Nov'], alpha =0.7, ax = ax, s= 10, legend=False)

            sns.scatterplot(data = plot_df[plot_df['summer_def'] == 'Aug-Nov'], x= 'site_num', y = 'slope_datetime_cent_95lo', palette='husl', hue = 'summer_def', hue_order=['~85% hypoxic days','Aug-Sep','Aug-MidOct','Aug-Oct','Aug-MidNov','Aug-Nov'],  alpha =0.7, ax = ax, s= 10, legend=False)

            sns.scatterplot(data = plot_df[plot_df['summer_def'] == 'Aug-Nov'], x= 'site_num', y = 'slope_datetime_cent', palette='husl', hue = 'summer_def', hue_order=['~85% hypoxic days','Aug-Sep','Aug-MidOct','Aug-Oct','Aug-MidNov','Aug-Nov'], alpha =0.7, ax = ax)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + var + '_' + stat + '_' + time_avg + '_Aug-Nov_slopes.png', bbox_inches='tight', dpi=500, transparent=False)
...
for site in long_site_list:
    ...
    for var in ['NO3_uM', 'Chl_mg_m3']:
        
        fig, ax = plt.subplots(figsize=(8,6))
        
        plot_df = odf_use[(odf_use['site'] == site) & (odf_use['var'] == var) & (odf_use['yearday'] >= 125) & (odf_use['yearday'] <=325)]
        
        sns.scatterplot(data = plot_df, x='datetime', y = 'val', hue='surf_deep', alpha=0.7)
        ...
        ax.set_xlim([datetime.date(1930,1,1), datetime.date(2024,12,31)])
        
        fig.tight_layout()
        
        plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_' + var +  '_~85%hypoxicdays_allsurfdeep.png', bbox_inches='tight', dpi=500, transparent=False)
