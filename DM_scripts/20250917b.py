...
plot_df__ = all_stats_filt[(all_stats_filt['stat'] == stat) & (all_stats_filt['season'] == 'loDO') & (all_stats_filt['var'] == 'deep_DO_sol_const_SA') & (all_stats_filt['site'].isin(long_site_list)) & (all_stats_filt['deep_DO_q'] == deep_DO_q)]

plot_df__['slope_datetime_sat_const_SA'] = plot_df__['slope_datetime']

plot_df___ = all_stats_filt[(all_stats_filt['stat'] == stat) & (all_stats_filt['season'] == 'loDO') & (all_stats_filt['var'] == 'deep_DO_sol_const_CT') & (all_stats_filt['site'].isin(long_site_list)) & (all_stats_filt['deep_DO_q'] == deep_DO_q)]
...
plot_df = pd.merge(plot_df, plot_df__[['site', 'slope_datetime_sat_const_SA']], on='site', how='left')

plot_df = pd.merge(plot_df, plot_df___[['site', 'slope_datetime_sat_const_CT']], on='site', how='left')


plot_df['pct_expl'] = plot_df['slope_datetime_sat']/plot_df['slope_datetime']

plot_df['pct_expl_const_SA'] = plot_df['slope_datetime_sat_const_SA']/plot_df['slope_datetime']

plot_df['pct_expl_const_CT'] = plot_df['slope_datetime_sat_const_CT']/plot_df['slope_datetime']



plot_df['pct_expl_sat_const_SA'] = plot_df['slope_datetime_sat_const_SA']/plot_df['slope_datetime_sat']

plot_df['pct_expl_sat_const_CT'] = plot_df['slope_datetime_sat_const_CT']/plot_df['slope_datetime_sat']