...
fig, axd = plt.subplot_mosaic(mosaic, figsize=(8.5,3), layout='constrained', sharex=True, gridspec_kw=dict(wspace=0.1))
    ...
    for stat in ['mk_ts']:
        ...
        for deep_DO_q in ['deep_DO_q50']:
            ...
            if 'surf' in var:
                ...
                label_depth = r'd/dt(Surface'
                
                color = '#E91E63'
                
            else:
                
                label_depth = r'd/dt(Deep'
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/longsites_trends_0.png', dpi=500,transparent=True, bbox_inches='tight')   
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/longsites_trends_1.png', dpi=500,transparent=True, bbox_inches='tight')   