...
fig, axd = plt.subplot_mosaic(mosaic, figsize=(10,10), layout='constrained', sharex=True, gridspec_kw=dict(wspace=0.1, hspace=0.1))
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/SA_trends.png', dpi=500,transparent=True, bbox_inches='tight')
