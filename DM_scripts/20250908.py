...
#edgecolors = {'point_jefferson': '#e04256', 'near_seattle_offshore': '#e04256', 'carr_inlet_mid':'#4565e8', 'saratoga_passage_mid':'#4565e8', 'lynch_cove_mid': '#4565e8'}
    ...
    for season in ['Dec-Mar (winter)', 'Apr-Jul (spring)', 'Aug-Nov (low-DO)']:
        ...
        for site in long_site_list:
            ...
            for depth in ['Surface', 'Bottom']:
                ...
                ax.scatter(plot_df['site_num'] + jitter[depth], plot_df['slope_datetime_cent'], color=palette[depth], edgecolors=edgecolors[site], marker=markers[var], s=50) #, marker=markers[depth], edgecolors=edgecolors[site])
                
                ax.plot([plot_df['site_num'] + jitter[depth], plot_df['site_num'] + jitter[depth]],[plot_df['slope_datetime_cent_95lo'], plot_df['slope_datetime_cent_95hi']], color=palette[depth], alpha =0.5, zorder = -5, linewidth=1)
