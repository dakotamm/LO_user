...
for site in odf_dens_use['site'].unique():
    ...
    for season in ['summer']:
        ...
        plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_' + season + '_strat_sol_augsept.png', bbox_inches='tight', dpi=500, transparent=False)
...
for site in odf_use['site'].unique():
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_surf_deep_decadal_nostrat_augsept.png', bbox_inches='tight', dpi=500, transparent=False)
