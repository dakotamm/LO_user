...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 22 15:43:23 2024
...
for stat in ['mk_ts']:
    ...
    for season in ['summer']:
        ...
        for deep_DO_q in ['deep_DO_q50']:
            ...
            sns.scatterplot(data = plot_df[plot_df['var'] == 'deep_DO_sol'], x= 'site_num', y = 'slope_datetime_cent_95hi', hue = 'site_type', palette=palette, marker=marker, ax = ax, s= 10, legend=False)
    
            sns.scatterplot(data = plot_df[plot_df['var'] == 'deep_DO_sol'], x= 'site_num', y = 'slope_datetime_cent_95lo', hue = 'site_type', palette=palette, marker=marker, ax = ax, s= 10, legend=False)
    
            sns.scatterplot(data = plot_df[plot_df['var'] == 'deep_DO_sol'], x= 'site_num', y = 'slope_datetime_cent', hue = 'site_type', palette=palette, marker=marker, ax = ax, s =50, legend=False)
            ...
            sns.scatterplot(data = plot_df[plot_df['var'] == 'deep_DO_mg_L'], x= 'site_num', y = 'slope_datetime_cent', hue = 'site_type', palette=palette, marker=marker, ax = ax, s =50, legend=False)
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/longsites_deepDOsoldeepDO.png', dpi=500,transparent=True, bbox_inches='tight')