...
for var in ['DO_mg_L']:
    ...
    for season in ['Winter (Dec-Mar)', 'Grow (Apr-Jul)', 'Lo-DO (Aug-Nov)']:
        ...
        ax.text(0.05,0.05, plot_labels[season] + ' ' + season, transform=ax.transAxes, verticalalignment='bottom', fontweight = 'bold', color='k', fontsize=12)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/paper_1_fig_10.png', dpi=500, transparent=True)
