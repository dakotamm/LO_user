...
ax.scatter(plot_df[plot_df['val'] <2]['year'], plot_df[plot_df['val'] <2]['yearday'], color = '#ff4040', label='hypoxic (<2 [mg/L])', alpha=0.9)
...
ax.axhspan(213,335, color = 'lightgray', alpha = 0.5, label = 'August-November (lo-DO)', zorder=-4) #july31/august1-september30/oct1
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/paper_1_fig_4_EPOC.png', bbox_inches='tight', dpi=500, transparent=True)