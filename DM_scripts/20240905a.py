...
for stat in ['mk_ts']:
    ...
    for season in ['summer']:
        ...
        for deep_DO_q in ['deep_DO_q50']:
            ...
            plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + 'longsites_' + stat + '_' + season + '_' + deep_DO_q + '_slopes_deepDOsoldeepDO.png', dpi=500,transparent=False, bbox_inches='tight')