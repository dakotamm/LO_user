...
odf_use_AugNov = odf_use_full[odf_use_full['season'] == 'loDO']

odf_calc_use_AugNov = odf_calc_use_full[odf_calc_use_full['season'] == 'loDO']
...
for deep_DO_q in ['deep_DO_q50']:
    ...
    odf_use = odf_use[odf_use['season'] == 'loDO']
    
    odf_calc_use = odf_calc_use[odf_calc_use['season'] == 'loDO']
...
for site in ['point_jefferson']:
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_q50DO_trend_0_ws.png', bbox_inches='tight', dpi=500, transparent=True)
...
for site in ['point_jefferson']:
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_q50DO_trend_1_ws.png', bbox_inches='tight', dpi=500, transparent=True)
...
for site in ['point_jefferson']:
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_q50DO_trend_2_ws.png', bbox_inches='tight', dpi=500, transparent=True)
...
for site in ['point_jefferson']:
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_q50DO_trend_3_ws.png', bbox_inches='tight', dpi=500, transparent=True)
