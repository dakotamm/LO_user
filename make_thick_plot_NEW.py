...
for seg_name in seg_list:
    ...
    for yr in np.arange(2008,2020):
        ...
        for (mon_num, mon_str) in zip(month_num, month_str):
            ...
            c0 = axes0[0,0].pcolormesh(plon,plat, sub_thick_obs_plot, cmap='Purples', alpha = 0.8, vmin = 0, vmax = 300)
            ...
            fig0.tight_layout()
            plt.savefig('/Users/dakotamascarenas/Desktop/pltz/'+seg_name + '_sub_thick_'+str(threshold_val)+'_mg_L_DO_casts_{:4%}_.png'.format(c), bbox_inches='tight')
...
#         pfun.start_plot(fs=14, figsize=(16,8))
#         fig0, axes0 = plt.subplots(nrows=1, ncols=2, squeeze=False)
        
#         c0 = axes0[0,0].pcolormesh(plon,plat, sub_thick_LO_his_plot, cmap='Purples', vmin = 0, vmax = 300)
...
#         c1 = axes0[0,1].pcolormesh(plon,plat, sub_thick_LO_casts_plot, cmap='Greens', alpha = 0.8, vmin = 0, vmax = 300)
