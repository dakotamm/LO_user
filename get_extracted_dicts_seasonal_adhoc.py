...
if info_fn.exists() & fn.exists():
    ...
    df.loc[df['month'].isin(winter_list), 'season'] = 'winter'
    
    df.loc[df['month'].isin(spring_list), 'season'] = 'spring'
    
    df.loc[df['month'].isin(summer_list), 'season'] = 'summer'
    
    df.loc[df['month'].isin(fall_list), 'season'] = 'fall'
    
    info_df.loc[info_df['month'].isin(winter_list), 'season'] = 'winter'
    
    info_df.loc[info_df['month'].isin(spring_list), 'season'] = 'spring'
    
    info_df.loc[info_df['month'].isin(summer_list), 'season'] = 'summer'
    
    info_df.loc[info_df['month'].isin(fall_list), 'season'] = 'fall'
