...
def get_his_fn_from_dt(Ldir, dt):
    ...
    if Ldir['list_type'] == 'hourly':
        ...
        date_string = dt.strftime(Ldir['ds_fmt'])
        fn = Ldir['roms_out1'] / Ldir['gtagex'] / ('f' + date_string) / ('ocean_his_' + his_num + '.nc')
    elif Ldir['list_type'] == 'lowpass':
        fn = Ldir['roms_out1'] / Ldir['gtagex'] / ('f' + date_string) / 'lowpassed.nc'
    elif Ldir['list_type'] == 'average':
        fn = Ldir['roms_out1'] / Ldir['gtagex'] / ('f' + date_string) / 'ocean_avg_0001.nc'
    return fn