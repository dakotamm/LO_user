"""
A tool to extract time series of volume and selected tracers and derived quantities
for budgets in the segments, using average files.

To test on mac:
run extract_segments_avg.py -gtx cas7_trapsV00_meV00 -ctag c0 -get_bio True -riv trapsV00 -0 2017.07.04 -1 2017.07.06
...
temp_dir = out_dir0 / ('segments_avg_temp_' + long_tag)
...
print(' Doing segment extraction (avg) for '.center(60,'='))
