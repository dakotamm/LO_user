...
Adapted for avg/Huon pipeline.

PERFORMANCE: 9 sec for test.

To test on mac:
run bulk_calc_avg.py -gtx cas7_trapsV00_meV00 -ctag c0 -0 2017.07.04 -1 2017.07.06
...
out_dir = out_dir0 / ('bulk_avg_' + Ldir['ds0'] + '_' + Ldir['ds1'])
...
for snp in sect_list:
    ...
    nlay =  31 # 30 DM changed 20260217
