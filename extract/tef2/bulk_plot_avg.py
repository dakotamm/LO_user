"""
Plot bulk fluxes as a time series, using avg/Huon pipeline outputs.

To test on mac:
run bulk_plot_avg -gtx cas7_trapsV00_meV00 -ctag c0 -0 2017.01.01 -1 2017.12.31 -test True
...
in_dir = out_dir0 / ('bulk_avg_' + Ldir['ds0'] + '_' + Ldir['ds1'])
out_dir = out_dir0 / ('bulk_avg_plots_' + Ldir['ds0'] + '_' + Ldir['ds1'])
