...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep  9 13:42:27 2024
...
mosaic = [['map_source', 'depth_time_series', 'depth_time_series', 'depth_time_series'], ['map_source', 'count_time_series', 'count_time_series', 'count_time_series']] #, ['map_source', '.', '.'],]
...
sns.scatterplot(data=plot_df, x='year', y='cid', hue='Data Source', ax=ax['count_time_series'], palette='Set2', alpha =0.5)
...
plt.savefig('/Users/dakotamascarenas/Desktop/pltz/source_locations_freq_depth_PECS_PRESENT.png', bbox_inches='tight', dpi=500, transparent=True)
...
for site in ['point_jefferson']:
    ...
    sns.scatterplot(data=plot_df[plot_df['site'] == site], x='year', y='cid', ax=ax['count_time_series'], color = '#ff4040', alpha=0.9, legend = False)
   ...
   # sns.scatterplot(data=plot_df[plot_df['site'] == site], x='year', y='z', ax=ax['depth_time_series'],  color='#ff4040', legend=False)
    ...
    plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + site + '_locations_freq_depth_PRESENT.png', bbox_inches='tight', dpi=500, transparent=True)