...
long_site_stats = all_stats[all_stats['site'].isin(long_site_list)]

long_site_stats = long_site_stats.pivot(index=['site','time_avg','summer_def'], columns = ['stat', 'var'], values=['p', 'slope_datetime_unc_cent', 'slope_datetime', 'slope_datetime_s'])


cats = ['surf_DO_mg_L', 'deep_DO_mg_L', 'surf_CT', 'deep_CT', 'surf_SA', 'deep_SA', 'strat_sigma', 'DO_sol']

cats0 = ['linreg','mk_ts']

cats1 = ['~85% hypoxic days', 'Aug-Sep', 'Aug-MidOct', 'Aug-Oct', 'Aug-MidNov', 'Aug-Nov']


long_site_stats = long_site_stats.reindex(cats0, axis=1, level=1)

long_site_stats = long_site_stats.reindex(cats, axis=1, level=2)


long_site_stats = long_site_stats.reindex(cats1, axis=0, level=2)



long_site_stats.to_excel('/Users/dakotamascarenas/Desktop/test.xlsx')
