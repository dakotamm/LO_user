...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 15 13:14:30 2024
...
mosaic = [['strat_sigma', 'DO_sol']]

fig, axd = plt.subplot_mosaic(mosaic, figsize=(5.5,2), layout='constrained', sharex=True, gridspec_kw=dict(wspace=0.1))
        ...
        for season in ['summer']:
            ...
            for deep_DO_q in ['deep_DO_q50']:
                ...
                if 'DO_mg_L' in var:
                    ...
                    label_var = 'Surface Saturation [DO]'
                    ...
                    label_var = 'Deep-Surface Density'
                ...
                plot_df = all_stats_filt[(all_stats_filt['stat'] == stat) & (all_stats_filt['summer_non_summer'] == season) & (all_stats_filt['var'] == var) & (all_stats_filt['site'].isin(long_site_list)) & (all_stats_filt['deep_DO_q'] == deep_DO_q)]
                ...
                sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent_95hi', color = color, marker=marker, ax = ax, s= 10, legend=False)
        
                sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent_95lo', color = color, marker=marker, ax = ax, s= 10, legend=False)
        
                sns.scatterplot(data = plot_df, x= 'site_num', y = 'slope_datetime_cent', color = color, marker=marker, ax = ax, s =50)
                ...
                plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + 'longsites_' + stat + '_' + season + '_' + deep_DO_q + '_slopes_stratsol.png', dpi=500,transparent=False, bbox_inches='tight')
...
label = r'$\Delta$ [DO] Not Explained By Saturation'
...
for stat in ['mk_ts']:
    ...
    for season in ['summer']:
        ...
        for deep_DO_q in ['deep_DO_q50']:
            ...
            DO_sol = plot_df[plot_df['var'] == 'DO_sol'][['site_num', 'slope_datetime_cent']]
            
            surf_DO_mg_L = plot_df[plot_df['var'] == 'surf_DO_mg_L'][['site_num', 'slope_datetime_cent']]
            
            deep_DO_mg_L = plot_df[plot_df['var'] == 'deep_DO_mg_L'][['site_num', 'slope_datetime_cent']]
            
            
            surf_DO_mg_L['diff'] = surf_DO_mg_L['slope_datetime_cent'] - DO_sol['slope_datetime_cent'].to_numpy() #all negative
            
            deep_DO_mg_L['diff'] = deep_DO_mg_L['slope_datetime_cent'] - DO_sol['slope_datetime_cent'].to_numpy() #all negative
            ...
            sns.scatterplot(data = surf_DO_mg_L, x= 'site_num', y = 'diff', color = '#E91E63', marker=marker, ax = ax, s =50, alpha = 0.7, label='Surface')
            
            sns.scatterplot(data = deep_DO_mg_L, x= 'site_num', y = 'diff', color = '#673AB7', marker=marker, ax = ax, s =50, alpha = 0.7, label = 'Deep')
            ...
            plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + 'longsites_' + stat + '_' + season + '_' + deep_DO_q + '_slopes_DOnormsol.png', dpi=500,transparent=False, bbox_inches='tight')
    ...
    for stat in ['mk_ts']:
        ...
        for season in ['non_summer']:
            ...
            for deep_DO_q in ['deep_DO_q50']:
                ...
                plt.savefig('/Users/dakotamascarenas/Desktop/pltz/' + 'longsites_' + stat + '_' + season + '_' + deep_DO_q + '_slopes.png', dpi=500,transparent=False, bbox_inches='tight')
