...
run extract_casts_segments_DM_2 -gtx cas6_v0_live -source dfo -otype ctd -year 2019 -test False
            ...
            for cid in info_df.index:
                ...
                if info_df.loc[cid,'time'] >= datetime(2019,6,1) and info_df.loc[cid,'time'] <= datetime(2019,8,31):
                    ...
                    if (ix in iii) and (iy in jjj):
                        ...
                        out_fn = out_dir / (str(int(cid)) + '_sog_G1_JunJulAug_2019_' + mon_str + '_2022.nc')
